...
export declare type TsFormatConfig = Omit<ts.FormatCodeSettings, 'indentMultiLineObjectLiteralBeginningOnBlankLine' | keyof ts.EditorSettings>;
...
export declare class LSConfigManager {
    ...
    getTsUserPreferences(lang: TsUserConfigLang): ts.UserPreferences;
